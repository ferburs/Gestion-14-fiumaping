...
// node_modules/@mappedin/mappedin-js/lib/esm/chunk-NCE64JTI.js
c();
function M(o, l = false) {
  let r = o[0].index !== null, f = new Set(Object.keys(o[0].attributes)), i = new Set(Object.keys(o[0].morphAttributes)), c2 = {}, e = {}, h = o[0].morphTargetsRelative, u = new fe(), d = 0;
  for (let t = 0; t < o.length; ++t) {
    ...
    for (let n in s.attributes) {
      ...
      c2[n] === void 0 && (c2[n] = []), c2[n].push(s.attributes[n]), a++;
    }
...
function B(o) {
  ...
  let e = new l(c2), h = new xe(e, r, f), u = 0;
  for (let d = 0; d < o.length; ++d) {
    let t = o[d];
...
function R(o, l) {
  if (l === Ju) return console.warn("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Geometry already defined as triangles."), o;
  if (l === Ku || l === $u) {
    let r = o.getIndex();
    if (r === null) {
    ...
    let f = r.count - 2, i = [];
    if (l === Ku) for (let e = 1; e <= f; e++) i.push(r.getX(0)), i.push(r.getX(e)), i.push(r.getX(e + 1));
    ...
    let c2 = o.clone();
    return c2.setIndex(i), c2.clearGroups(), c2;
...
//# sourceMappingURL=chunk-4OORONJH.js.map
